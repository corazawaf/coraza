...
Memoization is now enabled by default to reduce memory consumption in deployments that launch
several coraza instances. Use this tag to opt out if needed.
